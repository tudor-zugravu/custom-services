...
--
-- Host: localhost
-- Generation Time: Aug 19, 2017 at 12:24 AM
...
--
-- Database: `custom-services-product-based-no-categories`
--
...
--
ALTER TABLE `Receipts`
  MODIFY `receipt_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
--
