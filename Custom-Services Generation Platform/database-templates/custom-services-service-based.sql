...
--
-- Host: localhost
-- Generation Time: Aug 19, 2017 at 12:26 AM
...
--
-- Database: `custom-services-service-based`
--
...
--
ALTER TABLE `Offers`
  MODIFY `offer_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `Receipts`
--
ALTER TABLE `Receipts`
  MODIFY `receipt_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
--
