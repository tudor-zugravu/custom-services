...
INSERT INTO `System` (`system_id`, `type`, `main_colour`, `opaque_colour`, `background_colour`, `cell_background_colour`, `main_logo`, `main_title`, `main_tab_logo`, `main_tab_title`, `geolocation_notifications`, `navigation_logo`) VALUES
